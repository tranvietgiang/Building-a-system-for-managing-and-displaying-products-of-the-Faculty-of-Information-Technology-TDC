...
const NetworkDetail = ({ product, theme }) => {
  ...
  //           Đang tải thông tin sản phẩm Mạng máy tính...
  //         </p>
  //       </div>
  //     </div>
  //   );
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Sản phẩm Mạng máy tính không tồn tại hoặc đã bị xóa.
          </p>
        </div>
      </div>
    );
  ...
  // Lấy thông tin Network specific fields
  const networkDetail = product.network_detail || {};
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm">
                  <span className="px-3 py-1 bg-white/20 backdrop-blur rounded-full text-white flex items-center gap-1">
                    <Icons.Briefcase />
                    {product.major?.major_name || "Mạng máy tính"}
                  </span>
                  <span className="px-3 py-1 bg-white/20 backdrop-blur rounded-full text-white flex items-center gap-1">
                    <Icons.Grid />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-cyan-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Icons.Tool className="text-cyan-600" />
                    <span className="text-sm font-medium text-cyan-600">
                      Công cụ mô phỏng
                    </span>
                  </div>
                  <p className="text-gray-900 font-semibold">
                    {networkDetail.simulation_tool || "Chưa cập nhật"}
                  </p>
                </div>
                <div className="bg-cyan-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Icons.Globe className="text-cyan-600" />
                    <span className="text-sm font-medium text-cyan-600">
                      Giao thức mạng
                    </span>
                  </div>
                  <p className="text-gray-900 font-semibold">
                    {networkDetail.network_protocol || "Chưa cập nhật"}
                  </p>
                </div>
                <div className="bg-cyan-50 rounded-lg p-4 md:col-span-2">
                  <div className="flex items-center gap-2 mb-2">
                    <Icons.Share className="text-cyan-600" />
                    <span className="text-sm font-medium text-cyan-600">
                      Loại topology
                    </span>
                  </div>
                  <p className="text-gray-900 font-semibold">
                    {networkDetail.topology_type || "Chưa cập nhật"}
                  </p>
                </div>
                {networkDetail.config_file && (
                  <div className="bg-cyan-50 rounded-lg p-4 md:col-span-2">
                    <div className="flex items-center gap-2 mb-2">
                      <Icons.FileText className="text-cyan-600" />
                      <span className="text-sm font-medium text-cyan-600">
                        File cấu hình
                      </span>
                    </div>
                    <a
                      href={networkDetail.config_file}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-cyan-600 hover:text-cyan-700 font-semibold underline flex items-center gap-2"
                    >
                      <Icons.Download />
                      Tải file cấu hình
                    </a>
