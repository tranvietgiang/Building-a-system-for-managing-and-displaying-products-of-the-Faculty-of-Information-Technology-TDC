              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm">
                  <span className="px-3 py-1 bg-white/20 backdrop-blur rounded-full text-white flex items-center gap-1">
                    <Icons.Briefcase />
                    {product.major?.major_name || "Trí tuệ nhân tạo"}
                  </span>
                  <span className="px-3 py-1 bg-white/20 backdrop-blur rounded-full text-white flex items-center gap-1">
                    <Icons.Grid />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Icons.Cpu className="text-blue-600" />
                    <span className="text-sm font-medium text-blue-600">
                      Model sử dụng
                    </span>
                  </div>
                  <p className="text-gray-900 font-semibold">
                    {aiDetail.model_used || "Chưa cập nhật"}
                  </p>
                </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Icons.Framework className="text-blue-600" />
                    <span className="text-sm font-medium text-blue-600">
                      Framework
                    </span>
                  </div>
                  <p className="text-gray-900 font-semibold">
                    {aiDetail.framework || "Chưa cập nhật"}
                  </p>
                </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-gray-900 font-semibold">
                    {aiDetail.language || "Chưa cập nhật"}
                  </p>
                </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Icons.Database className="text-blue-600" />
                    <span className="text-sm font-medium text-blue-600">
                      Dataset sử dụng
                    </span>
                  </div>
                  <p className="text-gray-900 font-semibold">
                    {aiDetail.dataset_used || "Chưa cập nhật"}
                  </p>
                </div>
                {aiDetail.accuracy_score && (
                  <div className="bg-blue-50 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
            ...
            {(product.github_link || product.demo_link) && (
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  {aiDetail.dataset_link && (
                    <a
                      href={aiDetail.dataset_link}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition group"
                    >
